<template>
  <main id="homePage">
      ...
      <div class="gal" ref="gal_prod">
        <div class="gallery-projects" @touchstart="onScrollProkects($event)" >
          <template v-for="(p, index) in projects">
            <button class="project" :data_element="`project${index}`" :key="p.id" @click.prevent="setActiveProjectMouse2($event, `project${index}`, p.attributes.link)" ref="project">
    ...
    <div id="documentations" class="documentations container-main margin-main" ref="documentations">
      ...
      <div class="all-docs">
        <template v-for="(doc, index) in docs">
          <a target="_blank" rel="noopener noreferrer" :href="siteUrl + doc.doc.data.attributes.url" class="btn-docs" :key="doc.id" v-if="index < 5">
    ...
    <div id="instagram" class="instagram container-main margin-main">
      ...
      <div class="panel inst-photo">
        <img v-if="instagram[0]" :src="instagram[0].attributes.media_url" alt="">
      </div>
      <div class="panel quote">
        <svg>
      ...
      <div class="panel inst-photo">
        <img v-if="instagram[1]" :src="instagram[0].attributes.media_url" alt="">
      </div>
      <div class="panel quote">
        <svg>
