<template>
  <header id="headerMain" class="container">
    ...
    <ul class="menu">
      ...
      <li class="btn-menu">
        ...
        <div class="submenu">
          ...
          <button @click.prevent="goTo('about')">{{ $t('header.about_submenu.about_org') }}</button>
          <button @click.prevent="goTo('team')">{{ $t('header.about_submenu.team') }}</button>
          <button @click.prevent="goTo('supervis')">{{ $t('header.about_submenu.overwatch') }}</button>
          <button @click.prevent="goTo('supervis-children')">{{ $t('header.about_submenu.children_overwatch') }}</button>
        </div>
      </li>
      <template v-for="(m, index) in menu">
        <li class="btn-menu" :key="index">
          <!-- <nuxt-link :to="{ path: localePath('/'), hash: `#${m.to}` }"  class="menu-btn" active-class="active" :class="{disabled: m.disabled == true}">
            {{m.name}}
          </nuxt-link> -->
    ...
    <transition name="showHam">
      <div class="humburger" v-show="burgerOn">
        <div class="top">
        ...
        <ul class="menu">
          ...
          <ul class="hamsubmenu">
            <li class="btn-menu">
              <button class="menu-btn" @click.prevent="goTo('about')">{{ $t('header.about_submenu.about_org') }}</button>
            </li>
            <li class="btn-menu">
              <button class="menu-btn">{{ $t('header.about_submenu.team') }}</button>
            </li>
            <li class="btn-menu">
              <button class="menu-btn">{{ $t('header.about_submenu.overwatch') }}</button>
            </li>
            <li class="btn-menu">
              <button class="menu-btn">{{ $t('header.about_submenu.children_overwatch') }}</button>
            </li>
