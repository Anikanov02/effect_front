  ...
  <footer id="footer">
    <div class="container-footer">
      <div class="top">
        ...
        <div class="right">
          <p class="title">
            {{this.$t('footer.want_help')}}
          </p>
          <div class="requisites">
            <span class="suggest_help">{{this.$t('footer.suggest_help')}}</span>
            <p class="label">{{ name }}</p>
            <p class="label">{{ legalAddress }}</p>
            <p class="label">{{ mainEmail }}</p>
            <p class="label">{{ this.$t('footer.edrpou') }}: {{ code }}</p>
            <p class="label">{{ iban }}</p>
            <p class="label">{{ this.$t('footer.tel') }}: {{phones[0].phone }}</p>
          </div>
          
        </div>
        <div class="left-bot">
          <p class="site-rights">{{ this.$t('general.site_name') }}. <span class="rights-reserved">@ 2023. {{ this.$t('general.all_rights') }}.</span></p>
        </div>
        <div class="right-bot">
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      name: 'default/name',
      code: 'default/code',
      legalAddress: 'default/legalAddress',
      mainEmail: 'default/mainEmail',
    })
  },
  mounted(){
